...
const Header = () => {
    ...
    return (
        <header className="py-4 px-4 sticky top-0 z-50 header-bg backdrop-blur-md">
            ...
            {isMenuOpen && (
                <nav className="md:hidden py-4 px-2 mt-2 bg-gray-800 rounded-md animate-slideIn fixed top-14 right-0 w-64 shadow-lg">
                    <div className="flex flex-col space-y-3">
                        <a href="#funcionalidades" className="text-gray-300 hover:text-white px-4 py-2">Funcionalidades</a>
                        <a href="#precos" className="text-gray-300 hover:text-white px-4 py-2">Preços</a>
                        <a href="#" className="bg-purple-600 hover:bg-purple-700 mx-4 py-2 mt-2 rounded-md text-white text-center">Entrar</a>
                    </div>
                </nav>
            )}
        </header>
